...
def main():
    ...
    parser.add_argument(
        "--outdir",
        type=str,
        default="/home/nvidia/test_run/simclr_tropical_weighted_resnet50_outputs"
    )
    ...
    print(f"\nFound {len(records)} audio files total")
    ...
    for epoch in range(args.epochs):
        ...
        for i, (x1, x2, sources) in enumerate(pbar):
        ...
        ckpt_path = outdir / f"simclr_resnet50_epoch{epoch + 1}.pt"
    ...
    torch.save(
        ...
        outdir / "simclr_resnet50_final.pt",
    )
    ...
    plt.title("SimCLR ResNet50 tropical weighted SSL training loss")
    plt.tight_layout()
