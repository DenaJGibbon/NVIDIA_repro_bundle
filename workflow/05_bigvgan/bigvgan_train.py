...
def train(rank, a, h):
    ...
    # Initialize generator from NVIDIA pretrained BigVGAN-v2 weights.
    # Important: do NOT remove weight norm during training.
        ...
        with torch.no_grad():
            ...
            for j, batch in enumerate(tqdm(loader)):
                ...
                if (
                    ...
                    val_pesq_tot += 0  # PESQ disabled for non-speech bioacoustic clips
